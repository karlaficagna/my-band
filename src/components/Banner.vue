<template>
  <section class="banner">
    <div class="banner__imgs">
      <img class="images" :class="{'active' : activeFoto1}" src="../assets/foto_banner_1.jpeg" alt="foto banner" />
      <img class="images" :class="{'active' : activeFoto2}" src="../assets/Legiao_Urbana.jpg" alt="foto banner" />
    </div>
